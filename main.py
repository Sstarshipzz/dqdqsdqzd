...
async def handle_normal_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "admin":
        ...
        await query.message.edit_text(
            "✏️ Envoyez le nom de la nouvelle catégorie :",
            reply_markup=InlineKeyboardMarkup([[
    ...
    # Boutons d'annulation
        ...
        try:
            ...
            if product:
                ...
                if product.get('media'):
                    ...
                    caption += f"\n\n🔎 Média 1/{total_media}"  # Uniformisation ici aussi
                
                    if total_media > 1:
                        keyboard.append([
                            InlineKeyboardButton("➡️ Suivant", 
        ...
        try:
            ...
            await query.answer(f"✅ {cleaned} utilisateurs inactifs supprimés!")
                ...
                try:
                    ...
                    if product and 'media' in product:
                        ...
                        caption += f"💰 *Prix:*\n{product['price']}\n\n"
                        caption += f"📝 *Description:*\n{product['description']}"
                        caption += f"\n\n🔎 Média {current_index + 1}/{total_media}"
            ...
            print(f"Erreur dans handle_normal_buttons: {e}")
            await query.answer("Une erreur est survenue")
